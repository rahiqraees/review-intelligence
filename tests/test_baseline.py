"""Smoke tests for the Chapter 1 pipeline analyzers.

These load real models, so they are slow on first run. They verify shape and
sanity (a clearly positive review scores POSITIVE), not exact numbers.
"""
